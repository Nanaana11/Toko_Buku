...
<body class="d-flex flex-column flex-md-row">
    ...
    <section class="m-5 ps-0 flex-grow-1">
        <h1 class="mb-5">Add Publisher</h1>
        <form action="" method="post">
            <div class="row mb-3">
                <label for="nama_pener" class="col-sm-1 col-form-label">Name</label>
                <div class="col-sm-5">
                    <input type="text" class="form-control" name="nama_pener" id="nama_pener" placeholder="name">
                </div>
            </div>
            <div class="row mb-3">
                <label for="email_pener" class="col-sm-1 col-form-label">Email</label>
                <div class="col-sm-5">
                    <input type="email" class="form-control" name="email_pener"  id="email_pener" placeholder="email">
                </div>
            </div>
            <div class="row mb-3">
                <label for="pener_call" class="col-sm-1 col-form-label">Call</label>
                <div class="col-sm-5">
                    <input type="text" class="form-control" name="pener_call" id="pener_call" placeholder="call">
                </div>
            </div>
            <div class="row mb-3">
                <label for="pener_address" class="col-sm-1 col-form-label">Address</label>
                <div class="col-sm-5">
                    <input type="text" class="form-control" name="pener_address" id="pener_address" placeholder="address">
                </div>
            </div>
