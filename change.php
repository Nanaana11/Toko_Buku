...
$bookData = query("SELECT * FROM buku WHERE id_buku = $id_buku")[0]; 
...
<body class="d-flex flex-column flex-md-row">
    ...
    <section class="m-5 ps-0 flex-grow-1">
        <h1 class="mb-5">Change Data</h1>
        <form action="" method="post">
        <input type="hidden" name="id_buku" value="<?= $bookData["id_buku"]; ?>">
            <div class="row mb-3">
                <label for="nama_tipe" class="col-sm-2 col-form-label">Type of Book</label>
                <div class="col-sm-5">
                    <input type="text" class="form-control" name="nama_tipe" id="nama_tipe" required value="<?= $bookData["nama_tipe"]; ?>">
                </div>
            </div>
            <div class="row mb-3">
                <label for="nama_buku" class="col-sm-2 col-form-label">Title</label>
                <div class="col-sm-5">
                    <input type="text" class="form-control" name="nama_buku"  id="nama_buku"  required value="<?= $bookData["nama_buku"]; ?>">
                </div>
            </div>
            <div class="row mb-3">
                <label for="genre" class="col-sm-2 col-form-label">Genre</label>
                <div class="col-sm-5">
                    <input type="text" class="form-control" name="genre" id="genre" required value="<?= $bookData["genre"]; ?>">
                </div>
            </div>
            <div class="row mb-3">
                <label for="nama_au" class="col-sm-2 col-form-label">Author</label>
                <div class="col-sm-5">
                    <select class="form-select" aria-label="Default select example" name="nama_au" id="nama_au" required value="<?= $bookData["nama_au"]; ?>">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-5">
                    <select class="form-select" aria-label="Default select example" name="nama_pener" id="nama_pener" required value="<?= $bookData["nama_pener"]; ?>">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-5">
                    <input type="text" class="form-control" name="harga" id="harga"  required value="<?= $bookData["harga"]; ?>">
                </div>
            </div>
