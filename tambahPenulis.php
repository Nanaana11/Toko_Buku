...
<body class="d-flex flex-column flex-md-row">
    ...
    <section class="m-5 ps-0 flex-grow-1">
        <h1 class="mb-5">Add Author</h1>
        <form action="" method="post">
            <div class="row mb-3">
                <label for="nama_au" class="col-sm-1 col-form-label">Name</label>
                <div class="col-sm-5">
                    <input type="text" class="form-control" name="nama_au" id="nama_au" placeholder="name">
                </div>
            </div>
            <div class="row mb-3">
                <label for="au_email" class="col-sm-1 col-form-label">Email</label>
                <div class="col-sm-5">
                    <input type="email" class="form-control" name="au_email"  id="au_email" placeholder="email">
                </div>
            </div>
            <div class="row mb-3">
                <label for="au_call" class="col-sm-1 col-form-label">Call</label>
                <div class="col-sm-5">
                    <input type="text" class="form-control" name="au_call" id="au_call" placeholder="call">
                </div>
            </div>
            <div class="row mb-3">
                <label for="au_address" class="col-sm-1 col-form-label">Address</label>
                <div class="col-sm-5">
                    <input type="text" class="form-control" name="au_address" id="au_address" placeholder="address">
                </div>
            </div>
